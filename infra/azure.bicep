...
resource appServicePlan 'Microsoft.Web/serverfarms@2021-02-01' = {
  ...
  // kind: 'functionapp' is required for Consumption plan (Y1); harmless on Dedicated plans
  kind: 'functionapp'
}
  ...
  properties: {
    ...
    siteConfig: {
      appSettings: [
        ...
        {
          // Required for Consumption plan (Y1) — stores function code in file share
        ...
        {
          name: 'EIA_START_PERIOD'
          value: eiaStartPeriod
        }
        {
          name: 'EIA_API_KEY'
          value: '@Microsoft.KeyVault(VaultName=${keyVault.name};SecretName=${keyVault::eiaApiKeySecret.name})'
        }
        {
          name: 'TEAMSFX_ENV'
          value: teamsfxEnv
...
resource keyVault 'Microsoft.KeyVault/vaults@2021-06-01-preview' = {
  ...
  resource eiaApiKeySecret 'secrets' = {
    name: 'EiaApiKey'
    properties: {
      contentType: 'text/plain'
      value: eiaApiKey
